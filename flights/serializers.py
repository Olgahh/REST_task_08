...
class BookingDetailsSerializer(serializers.ModelSerializer):
	...
	def get_total(self,obj): #which is the total cost of the flight for all passengers.
...
class ProfileSerializer(serializers.ModelSerializer):
	...
	def get_past_bookings(self, obj):
		bookings = Booking.objects.filter(user = obj.user, date__lt = datetime.now().date())
